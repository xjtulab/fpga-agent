...
#include "./controller/FpgaController.hpp"
...
void run() {
  ...
  auto fpgaController = FpgaController::createShared();
  fpgaController->registerFpgaService();
  router->addController(fpgaController);
